<template>
    <div class="flex flex-wrap   items-center sm:px-2 px-5 justify-center gap-5 ">
        <div
            class="sm:w-64 w-full sm:px-0  h-28 flex px-5 justify-center items-center space-x-2 bg-white mt-4 rounded-lg">
