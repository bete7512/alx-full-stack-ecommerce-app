        ...
        <table class="w-full pt-2 text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody class="px-2">
                ...
                <tr v-for="buyer in buyers" :key="buyer.id"
                    ...
                    <td class="py-3 px-2">{{ buyer.first_name }}</td>
                    <td class="py-3 px-2">{{ buyer.last_name }}</td>
                    <td class="py-3 px-2">{{ buyer.email }}</td>
                    <td class="py-3 px-2">{{ buyer.created_at }}</td>
                    <td class="py-3 px-2">{{ buyer.address }}</td>

                    <td class="py-3 px-2">
                        <div class="flex space-x-2">
                            <button @click="view_product(buyer.id)">
                            ...
                            <button @click="delete_product(buyer.id)">
...
const buyers = computed(() => result.value?.buyer ?? []);
