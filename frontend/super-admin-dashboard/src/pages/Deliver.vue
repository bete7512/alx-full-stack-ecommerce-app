        ...
        <table class="w-full pt-2 text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody class="px-2">
                <tr v-for="delivery in deliveries" :key="delivery.id"
                    ...
                    <td class="py-3 px-2">{{ delivery.first_name }}</td>
                    <td class="py-3 px-2">{{ delivery.last_name }}</td>
                    <td class="py-3 px-2">{{ delivery.email }}</td>
                    <td class="py-3 px-2">{{ delivery.created_at }}</td>
                    <td class="py-3 px-2">{{ delivery.address }}</td>
                    <td class="py-3 px-2">
                        <div class="flex space-x-2">
                            <button @click="view_product(delivery.id)">
                            ...
                            <button @click="delete_product(delivery.id)">
...
const deliveries = computed(() => result.value?.deliver_agent ?? []);
