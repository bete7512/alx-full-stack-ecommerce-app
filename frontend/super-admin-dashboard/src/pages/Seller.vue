        ...
        <table class="w-full pt-2 text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th class="py-3 px-2">have company</th>
            ...
            <tbody class="px-2">
                <tr v-for="seller in sellers" :key="seller.id"
                    ...
                    <td class="py-3 px-2">{{ seller.first_name }}</td>
                    <td class="py-3 px-2">{{ seller.last_name }}</td>
                    <td class="py-3 px-2">{{ seller.email }}</td>
                    <td class="py-3 px-2">{{ seller.created_at }}</td>
                    <td class="py-3 px-2">{{ seller.have_company ? 'yes' : 'no' }}</td>

                    <td class="py-3 px-2">{{ seller.address }}</td>
                    <td class="py-3 px-2">
                        <div class="flex space-x-2">
                            <button @click="view_product(seller.id)">
                            ...
                            <button @click="delete_product(seller.id)">
...
const sellers = computed(() => result.value?.seller ?? []);
