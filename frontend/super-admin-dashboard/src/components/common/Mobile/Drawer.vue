<template>
  <div class="overlay top-0 lg:hidden md:w-1/3 w-1/2 z-10  left-0 flex items-center justify-center ">
    <div class="space-y-80 h-screen w-full  bg-gray-900 rounded-md">
      <div class=" w-full  border-zinc-900 h-auto space-y-4 px-2">
        <div class="w-full p-10 flex justify-between items-center px-2 pt-4">
          <div class="text-white flex justify-center">BS SElls</div>
          <button @click="emit('close')">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" class="bi bi-x-lg"
              viewBox="0 0 16 16">
        ...
        <nav class="">
          ...
          <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
            :class="[$route.name === 'addnewproduct' ? activeClass : inactiveClass]" to="/addnewproduct">
            <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
            :class="[$route.name === 'orders' ? activeClass : inactiveClass]" to="/orders">
