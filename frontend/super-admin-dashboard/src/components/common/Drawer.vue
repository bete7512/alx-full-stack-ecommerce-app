<template>
  <div class="w-72 fixed bg-stone-900 z-10 h-screen ">
    ...
    <nav class="">
      ...
      <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
        :class="[$route.name === 'sellers' ? activeClass : inactiveClass]" to='/sellers'>
        <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M2 10C2 5.58172 5.58172 2 10 2V10H18C18 14.4183 14.4183 18 10 18C5.58172 18 2 14.4183 2 10Z"
            fill="currentColor" />
          <path d="M12 2.25195C14.8113 2.97552 17.0245 5.18877 17.748 8.00004H12V2.25195Z" fill="currentColor" />
      ...
      <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
        :class="[$route.name === 'deliveryagents' ? activeClass : inactiveClass]" to="/deliveryagents">
        <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <span class="mx-4">Delivery Agents</span>
      </router-link>
      <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
      ...
      <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
        :class="[$route.name === 'customers' ? activeClass : inactiveClass]" to="/customers">
        <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
